...
func TestHealth(t *testing.T) {
	...
	if player.health > player.maxHealth {
		t.Fatalf("Healt went over the limit: %v", player.health, player.maxHealth)
	}
	...
	if player.health > player.maxHealth {
		t.Fatalf("Healt: %v. Maximum %v", player.health, player.maxHealth)
	}
}
...
func TestEnergy(t *testing.T) {
	...
	if player.energy > player.maxEnergy {
		t.Fatalf("Energy went over the limit: %v", player.energy, player.maxEnergy)
	}
